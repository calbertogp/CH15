...
"""
investment_risk = {'none':"100% bonds (AGG) 0% equities (SPY)", 'low':"60% bonds(AGG) 40% equities (SPY)", 'medium':"40% bonds (AGG) 60% equities (SPY)", 'high': "20% bonds (AGG) 80% equities (SPY)"}
...
def recommend_portfolio(intent_request):
    ...
    recommendation = investment_risk[risk_level.lower()] 
    ...
    return close(
        ...
        'Fulfilled',
            ...
            'content': f'Based on your risk level we recommend {recommendation}'
            }
        )
